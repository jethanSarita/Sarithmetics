...
public class Subscription {
    ...
    //Debug
    public static final long DEBUG_ITEM_COUNT_LIMIT = 10;
    public static final long DEBUG_TRANSACTION_COUNT_LIMIT = 10;
    public static final long DEBUG_CATEGORY_COUNT_LIMIT = 10;
    ...
    private static long getItemLimit(int subscription_type) {
        switch (subscription_type) {
            ...
            case 3: return DEBUG_ITEM_COUNT_LIMIT;
        }
        return -1;
    }
    ...
    private static long getTransactionLimit(int subscription_type) {
        switch (subscription_type) {
            ...
            case 3: return DEBUG_TRANSACTION_COUNT_LIMIT;
        }
        return -1;
    }
    ...
    private static long getCategoryLimit(int subscription_type) {
        switch (subscription_type) {
            ...
            case 3: return DEBUG_CATEGORY_COUNT_LIMIT;
        }
        return -1;
    }
}
